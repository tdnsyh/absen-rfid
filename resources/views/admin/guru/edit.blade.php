                ...
                <form action="{{ route('data-guru.update', $guru->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_kelamin" class="form-control">
                            <option value="L" @if ($guru->detailGuru->jenis_kelamin == 'L') selected @endif>Laki-laki</option>
                            <option value="P" @if ($guru->detailGuru->jenis_kelamin == 'P') selected @endif>Perempuan</option>
                        </select>
                    </div>
